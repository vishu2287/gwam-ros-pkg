"""autogenerated by genmsg_py from AddOffsetRequest.msg. Do not edit."""
import roslib.message
import struct


class AddOffsetRequest(roslib.message.Message):
  _md5sum = "10fe27c5d4591264b9d05acc7497a18a"
  _type = "microstrain_3dmgx3_imu/AddOffsetRequest"
...
"""autogenerated by genmsg_py from AddOffsetResponse.msg. Do not edit."""
import roslib.message
import struct


class AddOffsetResponse(roslib.message.Message):
  _md5sum = "5dea42ce4656fada4736ce3508b56aca"
  _type = "microstrain_3dmgx3_imu/AddOffsetResponse"
  _has_header = False #flag to mark the presence of a Header object
...
_struct_I = roslib.message.struct_I
_struct_d = struct.Struct("<d")
class AddOffset(roslib.message.ServiceDefinition):
  _type          = 'microstrain_3dmgx3_imu/AddOffset'
