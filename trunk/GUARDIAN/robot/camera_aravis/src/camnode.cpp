...
//            std::vector<uint16_t> this_data(buffer->size);
            ...
            //msg.encoding = "bayer_grbg16";
            //msg.encoding = "yuv422";  // YUV422 ="yuv422"
...

    {
        ...
        */
		...
		arv_camera_get_region (camera, &x, &y, &width, &height);
                ...
                ROS_INFO("****************************************  arv_camera_get_region width=%d height=%d", width, height);
